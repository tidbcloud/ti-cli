...
const (
	...
	FSTokenIssueScoped      Permission = "fs.token.issue_scoped"
	...
	FSExtractConfigRead     Permission = "fs.extract_config.read"
	FSExtractConfigUpdate   Permission = "fs.extract_config.update"
	FSEmbeddingConfigRead   Permission = "fs.embedding_config.read"
	FSEmbeddingConfigUpdate Permission = "fs.embedding_config.update"
...
var commandPermissions = map[string]Permission{
	...
	"ti fs generate-file-system-scoped-token":            FSTokenIssueScoped,
	...
	"ti fs describe-file-system-extract-configuration":   FSExtractConfigRead,
	"ti fs update-file-system-extract-configuration":     FSExtractConfigUpdate,
	"ti fs describe-file-system-embedding-configuration": FSEmbeddingConfigRead,
	"ti fs update-file-system-embedding-configuration":   FSEmbeddingConfigUpdate,
